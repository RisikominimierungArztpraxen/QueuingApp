package de.risikominimierungarztpraxen.queuingApp.rest.configuration;
...
public class SwaggerDocumentationConfig {
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("de.risikominimierungarztpraxen.queuingApp.rest.api"))
                .build()
