...
public class AppointmentChange {
    ...
    public AppointmentChange notifications(List<AppointmentBaseNotifications> notifications) {
        this.notifications = notifications;
        return this;
    }

    public AppointmentChange addNotificationsItem(AppointmentBaseNotifications notificationsItem) {
